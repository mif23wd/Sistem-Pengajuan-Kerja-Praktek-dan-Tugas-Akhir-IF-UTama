...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url().'login'; ?>"><img src="<?php echo base_url(); ?>asset/Utama.png" width="25%" height="25%"><br><b>Pusat Data Tugas Akhir dan Kerja Praktek Teknik Informatika</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><?php if (isset($pesan)) {echo $pesan;} ?></p>
