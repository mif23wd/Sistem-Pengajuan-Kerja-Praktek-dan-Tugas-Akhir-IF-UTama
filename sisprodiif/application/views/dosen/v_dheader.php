  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php if ($this->session->userdata('jenis_bimbingan')=="Tugas Akhir"||$this->session->userdata('jenis_bimbingan')=="Both"): ?>
        <li class="<?php if (isset($active_ta)) {echo $active_ta;} ?>"><a href="<?php echo base_url(); ?>dosen/tugasakhir"><i class="fa fa-clone"></i> <span>List Tugas Akhir</span></a></li>  
        <?php endif ?>
        <?php if ($this->session->userdata('jenis_bimbingan')=="Kerja Praktek"||$this->session->userdata('jenis_bimbingan')=="Both"): ?>
        <li class="<?php if (isset($active_kp)) {echo $active_kp;} ?>"><a href="<?php echo base_url(); ?>dosen/kerjapraktek"><i class="fa fa-clone"></i> <span>List Kerja Praktek</span></a></li>  
        <?php endif ?>
        <?php if ($this->session->userdata('konsentrasi')!=''): ?>
        <li class="<?php if (isset($active_kon)) {echo $active_kon;} ?>"><a href="<?php echo base_url(); ?>dosen/konsentrasi"><i class="fa fa-clone"></i> <span>List Tugas Akhir Konsentrasi</span></a></li>  
        <?php endif ?>
        <li class="<?php if (isset($active_setting)) {echo $active_setting;} ?>"><a href="<?php echo base_url(); ?>dosen/setting"><i class="fa fa-wrench"></i> <span>Setting</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
