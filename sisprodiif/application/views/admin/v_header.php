  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?php if (isset($active_home)) {echo $active_home;} ?>"><a href="<?php echo base_url(); ?>admin"><i class="fa fa-home"></i> <span>Home</span></a></li>
        <li class="treeview <?php if (isset($active_list_peng)) {echo $active_list_peng;} ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php if (isset($active_kp)) {echo $active_kp;} ?>"><a href="<?php echo base_url(); ?>admin/listpengajuankp"><i class="fa fa-pencil"></i> <span>Kerja Praktek</span></a></li>
            <li class="<?php if (isset($active_ta)) {echo $active_ta;} ?>"><a href="<?php echo base_url(); ?>admin/listpengajuanta"><i class="fa fa-pencil"></i> <span>Tugas Akhir</span></a></li>
          </ul>
        </li>
        <li class="treeview <?php if (isset($active_list_takp)) {echo $active_list_takp;} ?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php if (isset($active_kp)) {echo $active_kp;} ?>"><a href="<?php echo base_url(); ?>admin/listkp"><i class="fa fa-book"></i> <span>Kerja Praktek</span></a></li>
            <li class="<?php if (isset($active_ta)) {echo $active_ta;} ?>"><a href="<?php echo base_url(); ?>admin/listta"><i class="fa fa-book"></i> <span>Tugas Akhir</span></a></li>
          </ul>
        </li>
        <li class="<?php if (isset($active_ddosen)) {echo $active_ddosen;} ?>"><a href="<?php echo base_url(); ?>admin/datadosen"><i class="fa fa-industry"></i> <span>Data Dosen</span></a></li>
        <li class="<?php if (isset($active_akun)) {echo $active_akun;} ?>"><a href="<?php echo base_url(); ?>admin/manajemenakun"><i class="fa fa-clone"></i> <span>Manajemen Akun</span></a></li>
        <li class="<?php if (isset($active_setting)) {echo $active_setting;} ?>"><a href="<?php echo base_url(); ?>admin/setting"><i class="fa fa-wrench"></i> <span>Setting</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
