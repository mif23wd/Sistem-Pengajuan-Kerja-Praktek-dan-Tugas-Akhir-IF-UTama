          ...
          <div class="col-md-10">
            <div class="box box-default">
              <div class="box-header with-border">
                ...
                <a href="<?php echo base_url().'c_admin/cetakkartukp/'.$kp->id_kp ?>" class="btn btn-info pull-right">Cetak Kartu</a>
              </div>
              <div class="box-body">
              ...
              <div class="box-footer">
                <a href="<?php echo base_url().'admin/listkp' ?>" class="btn btn-info pull-left"><i class="glyphicon glyphicon-chevron-left"></i> Kembali</a>
                <a href="<?php echo base_url().'c_admin/editkp/'.$kp->id_kp ?>" class="btn btn-info pull-right"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
