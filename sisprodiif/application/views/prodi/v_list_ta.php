	    	...
	    	<div class="col-xs-12">
	    	  <div class="box">
	            ...
	            <div class="box-body">
	            	<div class="col-md-12">
	            		<table class="table">
	            			<?php echo form_open('c_prodi/exportxlstasort'); ?>
		            		<tr>
	          ...
	          <div class="box">
	            <div class="box-header">
	              ...
	              <div class="box-tools pull-right">
	              	<a href="<?php echo base_url(); ?>c_prodi/exportxlsta" class="btn btn-box-tool ">AMBIL DATA EXCEL</a>
	            ...
	            <div class="box-body">
	              <table id="example3" class="table table-bordered table-striped">
	                ...
	                <tr>
	                  ...
	                  <td><center><a href="<?php echo base_url().'c_prodi/viewta/'.$ta->id_ta; ?>"> <i class="glyphicon glyphicon-search"></i></a><a onclick="return confirm('Apa anda ini menghapus data tugas akhir id=<?php echo $ta->id_ta; ?> ini ');" href="<?php echo base_url().'c_prodi/hapusdta/'.$ta->id_ta; ?>"> <i class="glyphicon glyphicon-trash"></i></a></center></td>
	                </tr>
	                <?php } ?>
	                </tbody>
	              </table>
